        ...
        <div id="product-grid" style="display: flex;flex-wrap: wrap;">
             ...
             <div class="product-item cards" width="200px" >
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong> sandwich</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/kfcs.jpg" width="300px"></div>
                    ...
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong>kfc pieces</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/kfcp.jpg" width="300"></div>
