        ...
        <div id="product-grid" style="display: flex;flex-wrap: wrap;">
             ...
             <div class="product-item cards" width="200px" >
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong> sandwiches</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/sandwicheswimpy.jpg" width="300px"></div>
                        <div class="product-price">price: 90 LE </div>
                    ...
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong>Breakfast</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/breakfastwimpy.png" width="300"></div>
                        <div class="product-price">price: 170 LE</div>
                        <div class="product-price">Qty: </div>
                             <div>
                            <input type="hidden" name="product_id" value="id"/>
                            <input type="hidden" name="ProductsQty"
