...
?>
        <h2 style="text-align:center; font-weight: bold;">Drinks</h2>
        <div id="product-grid" style="display: flex;flex-wrap: wrap;">

             <div class="product-item cards" width="200px" >
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong> cola</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/cola.jpg"></div>
                        <div class="product-price">price: 40 LE </div>
                    ...
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong>orange juice</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/drinkskfc.jpg"width="200"></div>
                        <div class="product-price">price: 60 LE</div>
                        <div class="product-price">Qty: </div>
                             <div>
                            <input type="hidden" name="product_id" value="id"/>
                            <input type="hidden" name="ProductsQty"
