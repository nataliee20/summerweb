...
?>
        <h2 style="text-align:center; font-weight: bold;">vegetables</h2>
        <div id="product-grid" style="display: flex;flex-wrap: wrap;">

             <div class="product-item cards" width="200px" >
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong> cucumbers</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/cucumbers.jfif"></div>
                    ...
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong>tomatos</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/tom2.jfif"></div>
