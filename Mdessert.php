        ...
        <div id="product-grid" style="display: flex;flex-wrap: wrap;">
             ...
             <div class="product-item cards" width="200px" >
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong> sundae</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/dessert.jpg"></div>
                    ...
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong>Mcflurry</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/mcflurry.jpg"></div>
