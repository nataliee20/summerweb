...
?>
        <h2 style="text-align:center; font-weight: bold;">fruits</h2>
        <div id="product-grid" style="display: flex;flex-wrap: wrap;">

             <div class="product-item cards" width="200px" >
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong> strawberry</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/strawberry.jfif"></div>
                    ...
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong>oranges</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/oranges.jpg"></div>
