...
?>
        <h2 style="text-align:center; font-weight: bold;">Dessert</h2>
        <div id="product-grid" style="display: flex;flex-wrap: wrap;">

             <div class="product-item cards" width="200px" >
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong> waffle</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/wimpydes2.jpg"></div>
                    ...
                    <form method="post" action="Products">
                        <div class="mt-2 f-16"><strong>Ice-Cream</strong></div>
                        <div class="product-image"><img
                                    src="http://localhost/summerweb/images/icecream.jpg"></div>
